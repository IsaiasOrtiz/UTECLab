...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Editar<small>Editar carrera o profesión</small></h1>
    </section>
    <!-- Main content -->
                    ...
                    <form role="form">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="nombreCoPEdit">Nuevo nombre:</label>
                                    <input type="text" class="form-control" id="nombreCoPEdit" name="nombreCoPEdit">
                                </div>
                            </div>
                        </div>
                        <!-- /.box-body -->
